module Xpm_memory_tdpram = struct
  ...
  module Make (P : P) = struct
    ...
    let create ?lib ?arch ?instance inputs =
      create ?lib ?arch ?instance ~parameters:params ~name:"xpm_memory_tdpram" inputs
  end
end
...
module Xpm_fifo_async = struct
  ...
  module Make (P : P) = struct
    ...
    open struct include Hardcaml.Instantiation.With_interface(I)(O) end
    let create ?lib ?arch ?instance inputs =
      create ?lib ?arch ?instance ~parameters:params ~name:"xpm_fifo_async" inputs
  end
end
...
module Xpm_fifo_sync = struct
  ...
  module Make (P : P) = struct
    ...
    open struct include Hardcaml.Instantiation.With_interface(I)(O) end
    let create ?lib ?arch ?instance inputs =
      create ?lib ?arch ?instance ~parameters:params ~name:"xpm_fifo_sync" inputs
  end
end
